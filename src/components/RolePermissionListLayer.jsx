...
const ROLE_DEFAULTS = {
  TEACHER: {
    ...
    QUIZZES:            { can_view: true,  can_create: true,  can_edit: true,  can_delete: false },
    ASSIGNMENTS:        { can_view: true,  can_create: true,  can_edit: true,  can_delete: false },
  ...
  STUDENT: {
    ...
    QUIZZES:            { can_view: false, can_create: false, can_edit: false, can_delete: false },
    ASSIGNMENTS:        { can_view: false, can_create: false, can_edit: false, can_delete: false },
    COURSE_ASSIGNMENTS: { can_view: true,  can_create: false, can_edit: false, can_delete: false },
...
const MODULE_LABEL = {
  ...
  CLO:                "CLO",
  USERS:              "Users",
  ASSESSMENTS:        "Assessments (Papers)",
  QUIZZES:            "Quizzes",
...
const MODULE_ICON = {
  ...
  QUIZZES:            "solar:question-circle-outline",
  ASSIGNMENTS:        "solar:notebook-bookmark-outline",
