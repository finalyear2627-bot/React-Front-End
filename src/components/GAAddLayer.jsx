...
const GAAddLayer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await gaService.create(payload);
      if (res?.status?.code !== 0) { showError(res?.status?.message || "Create failed"); return; }
      showSuccess(res?.status?.message || "GA created successfully");
      navigate("/gas");
    } catch (err) {
          ...
          <div className="col-xxl-7 col-xl-9 col-lg-10">
            <div className="card border">
              <div className="card-header border-bottom py-16 px-24">
                <h5 className="mb-0">Add New Graduate Attribute (GA)</h5>
              </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-20">
                    ...
                    <textarea
                      ...
                      name="description"
                      rows={4}
                      placeholder="Describe this graduate attribute…"
                  ...
                  <div className="mb-20">
                    ...
                    {!formData.program ? (
                      ...
                      <div className="alert alert-info radius-8 text-sm mb-0">
                        No PLOs found for this program. Add PLOs first.
                      </div>
                    ) : (
